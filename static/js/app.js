...
startButton.addEventListener("click", async () => {
    try {
        ...
        videoFeed.src = "/video-feed?" + Date.now();
...
stopButton.addEventListener("click", async () => {
    ...
    cameraPlaceholder.style.flexDirection = "column";
...
uploadForm.addEventListener("submit", async (event) => {
    ...
    try {
        ...
        resultImage.src = data.image_url + "?" + Date.now();
        ...
        // Update dashboard
        totalCount.textContent = totalDetected;
        maskCount.textContent = totalWithMask;
        noMaskCount.textContent = totalWithoutMask;
